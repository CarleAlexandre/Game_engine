...
void main() {
    ...
    switch(face) {
        case FACE_YP: face_offset = vec3(0.0, 0.25, 0.0); break;
        case FACE_Y:  face_offset = vec3(0.0, -0.25, 0.0); break;
        case FACE_XP: face_offset = vec3(0.25, 0.0, 0.0); break;
        case FACE_X:  face_offset = vec3(-0.25, 0.0, 0.0); break;
        case FACE_ZP: face_offset = vec3(0.0, 0.0, 0.25); break;
        case FACE_Z:  face_offset = vec3(0.0, 0.0, -0.25); break;
    }

    // Final position calculation
    vec3 world_pos = voxel_center + face_offset;
